...
class SurveyForm(FlaskForm, myQuestion, choiceList):
    question1 = SelectField(myQuestion[0], choices=[(choiceList[0][0], 1), (choiceList[0][1], 2), (choiceList[0][2], 3),
                            (choiceList[0][3], 4)])
    ...
    question9 = SelectField(myQuestion[8], choices=[(choiceList[8][0], 1), (choiceList[8][1], 2), (choiceList[8][2], 3),
                            (choiceList[8][3], 4)])
    question10 = SelectField(myQuestion[9], choices=[(choiceList[9][0], 1), (choiceList[9][1], 2), (choiceList[9][2], 3),
                             (choiceList[9][3], 4)])
>>>>>>> 0942092924cd58f467e42116cf475a3d7d87263b
